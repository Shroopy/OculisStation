...
/datum/controller/subsystem/processing/quirks/proc/AssignQuirks(mob/living/user, client/applied_client, list/blacklist = list(), unique = TRUE) // OCULIS EDIT ADDITION: add blacklist arg, add unique
	var/badquirk = FALSE
